...
SetupConsole ( void )
{
    ...
    // Desativando Fun��es Espec�ficas do Console
    ...
    CS_SETTITLE ("Color Editor");                         // DEFININDO O T�TULO DO CONSOLE
...
DrawnMenu ( void )
{
    ...
    */
    ...
    /* Printando os textos dos bot�es */
    PROP_BACKGROUNDCOLOR ( CYAN_BACKGROUND );
...
MenuActions ( void )
{
    ...
    */
    ...
    int  pos = MenuChoice;  // int  de posi��o



    // Loop Para Sele��o de Menu
...
DrawnStart ( void )
{
    ...
    */
    ...
    /* Fun��o Para Desenhar no Grid e Executar Comandos */
    StartActions ();
}
...
StartActions ( void )
{
    ...
    */
    ...
    if ( strcmp ( COMMAND , "R" ) == 0 or strcmp ( COMMAND , "r" ) == 0 )
    {
        ...
        // Recursividade
        // Voltando ao inic�o dessa fun��o
        StartActions ();
    }
...
DrawnLoad ( void )
{
    ...
    /* Compara��es para Saber se Ir� Retornar ao Menu */
...
DrawnAbout ( void )
{
    ...
    /* Printando as Informa��es Finais */
